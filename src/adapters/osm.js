...
import { gouJianTu, zuiJinJieDian, dengShiChang, luJing, MO_REN_BAN_JING } from '../core/osmluwang.js';
...
const POI_GUIZE = [
  ...
  { fenlei: 'yiliao', ming: '药店', pan: (t) => t.amenity === 'pharmacy' || t.healthcare === 'pharmacy' },
  ...
  },
  {
    fenlei: 'yanglao',
    ming: '养老院',
    pan: (t) => ['nursing_home', 'retirement_home'].includes(t.amenity) || t.amenity === 'social_facility',
  },
  { fenlei: 'jiaotong', ming: '公交站', pan: (t) => t.highway === 'bus_stop' || t.amenity === 'bus_station' },
  { fenlei: 'jiaotong', ming: '地铁站', pan: (t) => t.railway === 'station' || t.railway === 'subway_entrance' },
